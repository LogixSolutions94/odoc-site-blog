...
export const WHITE_PAPER = {
  ...
  faqs: [
    ...
    {
      q: "Combien ça coûte ?",
      a: "Vous pouvez commencer gratuitement : diagnostic, générateur Factur-X et vérificateur sont sans compte. Les offres OdocPilot démarrent à 29 €/mois par entreprise, avec un essai de 14 jours sans carte bancaire.",
    },
  ] as WpFaq[],
};
