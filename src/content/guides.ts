...
export const GUIDES: Guide[] = [
  {
    ...
    faqs: [
      ...
      { q: "Combien ça coûte de se mettre en conformité ?", a: "Vous pouvez commencer gratuitement : générateur Factur-X, diagnostic et vérificateur sont sans compte. Les offres OdocPilot démarrent à 49 €/mois, par entreprise et sans coût par utilisateur." },
    ],
    related: [
