...
export const GUIDES: Guide[] = [
  {
    ...
    faqs: [
      ...
      { q: "Combien ça coûte de se mettre en conformité ?", a: "Vous pouvez commencer gratuitement : générateur Factur-X, diagnostic et vérificateur sont sans compte. Les offres OdocPilot démarrent à 29 €/mois, par entreprise et copilote IA inclus, avec un essai de 14 jours sans carte bancaire." },
    ],
    related: [
  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        atomic:
          "Vous pouvez commencer sans rien payer : le diagnostic, le générateur Factur-X et le vérificateur sont gratuits et sans inscription. Le palier Conformité d'OdocPilot est gratuit ; les offres complètes démarrent à 29 €/mois, copilote IA inclus.",
        body: [
