...
const ODOC = {
  ...
  iaPrepare: true,
  souverainete: "Données en France, IA européenne (Mistral)",
  gratuit: "Palier Conformité 0€ + essai 14 j sans CB",
  prix: "Par entreprise, utilisateurs inclus selon l'offre (0 € / 29 / 49 / 89 / 149)",
};
...
export const COMPARISONS: Comparison[] = [
  ...
  },
  {
    ...
    faqs: [
      ...
      { q: "Lequel est le moins cher pour démarrer ?", a: "OdocPilot propose un palier Conformité gratuit et des offres dès 29 €/mois par entreprise. Axonaut fonctionne par utilisateur, avec un essai gratuit de 15 jours mais pas de palier gratuit permanent." },
