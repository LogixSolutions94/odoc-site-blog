  ...
  return (
    <div className="mx-auto max-w-3xl py-16 sm:py-24 px-4 sm:px-6 lg:px-8">
      <SEOHead
        ...
        description="Mentions légales du site odocpilot.com : identification de l'éditeur, entreprise individuelle Riad Brahimi (SIREN 842 920 084), hébergeur, propriété intellectuelle et données personnelles."
