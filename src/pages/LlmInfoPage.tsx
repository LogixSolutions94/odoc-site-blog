...
const faqs: { q: string; a: string }[] = [
  ...
  { q: "Combien coûte OdocPilot ?", a: "OdocPilot propose un palier Conformité gratuit (générateur Factur-X, diagnostic, vérificateur, 50 documents par mois sans copilote), puis quatre offres payantes par entreprise : Essentiel à 29 €/mois avec le copilote IA inclus, Pro à 49 €/mois, Équipe à 89 €/mois avec 5 utilisateurs inclus et Manager à 149 €/mois avec 10 utilisateurs. Un siège supplémentaire coûte 12 €. L'essai des offres payantes dure 14 jours, sans carte bancaire." },
];
