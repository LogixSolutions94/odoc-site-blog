...
export default function CguPage() {
  return (
    <div className="mx-auto max-w-3xl py-16 sm:py-24 px-4 sm:px-6 lg:px-8">
      <SEOHead
        title="Conditions générales d'utilisation | OdocPilot"
        description="Conditions générales d'utilisation de la plateforme OdocPilot, éditée par une entreprise individuelle immatriculée sous le SIREN 842 920 084."
        canonical="/cgu"
      />
      ...
      <div className="mt-8 space-y-8 text-muted-foreground leading-relaxed">
        ...
        <section>
          ...
          <p className="mt-3">
            Les présentes conditions générales d'utilisation (ci-après « CGU ») régissent l'accès et l'utilisation de la plateforme SaaS OdocPilot, éditée par Monsieur Riad Brahimi, entrepreneur individuel immatriculé sous le SIREN 842 920 084 et exerçant sous le nom commercial Logix Solutions (ci-après « l'éditeur »). OdocPilot est une solution d'intelligence documentaire permettant aux entreprises de centraliser, analyser et exploiter leurs documents administratifs et financiers (factures, contrats, mails, pièces jointes) grâce à l'intelligence artificielle.
          </p>
          <p className="mt-2">
        ...
        <section>
          ...
          <p className="mt-2">
            L'utilisateur est seul responsable de toute activité effectuée depuis son compte. En cas de suspicion d'utilisation non autorisée, l'utilisateur doit en informer immédiatement l'éditeur à l'adresse contact@odocpilot.com.
          </p>
          <p className="mt-2">
            L'éditeur se réserve le droit de suspendre ou de résilier l'accès d'un utilisateur en cas de non-respect des présentes CGU, sans préavis ni indemnité.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="mt-3">
            OdocPilot propose plusieurs formules d'abonnement selon le plan tarifaire en vigueur, consultable sur la page <a href="/pricing" className="text-primary hover:underline">Tarifs</a> (à partir de 49,99 € HT/mois). Les prix peuvent évoluer ; seule la page Tarifs fait foi.
          </p>
          <p className="mt-2">
        ...
        <section>
          ...
          <p className="mt-3">
            L'éditeur met en œuvre tous les moyens raisonnables pour assurer la disponibilité et le bon fonctionnement de la plateforme. Toutefois, le service est fourni « en l'état » et l'éditeur ne garantit pas l'absence d'interruptions, d'erreurs ou de dysfonctionnements.
          </p>
          <p className="mt-2">
            En aucun cas l'éditeur ne pourra être tenu responsable des dommages indirects, pertes de bénéfices, pertes de données ou préjudices commerciaux résultant de l'utilisation ou de l'impossibilité d'utiliser la plateforme.
          </p>
          <p className="mt-2">
            La responsabilité totale de l'éditeur au titre des présentes CGU est limitée au montant des sommes effectivement versées par l'utilisateur au cours des 12 mois précédant l'événement à l'origine du dommage.
          </p>
          <p className="mt-2">
