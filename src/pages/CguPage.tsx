    ...
    <div className="mx-auto max-w-3xl py-16 sm:py-24 px-4 sm:px-6 lg:px-8">
      ...
      <div className="mt-8 space-y-8 text-muted-foreground leading-relaxed">
        ...
        <section>
          ...
          <p className="mt-3">
            OdocPilot propose plusieurs formules d'abonnement selon le plan tarifaire en vigueur, consultable sur la page <a href="/pricing" className="text-primary hover:underline">Tarifs</a> (à partir de 29 € HT/mois). Les prix peuvent évoluer ; seule la page Tarifs fait foi.
          </p>
          <p className="mt-2">
