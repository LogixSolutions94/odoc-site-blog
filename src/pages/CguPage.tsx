    ...
    <div className="mx-auto max-w-3xl py-16 sm:py-24 px-4 sm:px-6 lg:px-8">
      ...
      <div className="mt-8 space-y-8 text-muted-foreground leading-relaxed">
        ...
        <section>
          ...
          <p className="mt-2">
            En aucun cas l'éditeur ne pourra être tenue responsable des dommages indirects, pertes de bénéfices, pertes de données ou préjudices commerciaux résultant de l'utilisation ou de l'impossibilité d'utiliser la plateforme.
          </p>
          <p className="mt-2">
